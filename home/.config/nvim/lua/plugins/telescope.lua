...
return {
    ...
    keys = function()
        ...
        return {
            ...
            { "<leader>fw", mode = { "n" }, builtin.builtin, desc = "Telescope find builtin windows" },
            { "<leader>fs", mode = { "n", "x" }, builtin.grep_string, desc = "Telescope find string" },
            ...
            { "<leader>fx", mode = { "n" }, builtin.marks, desc = "Telescope find marks" },
            { "<leader>ss", mode = { "n" }, builtin.spell_suggest, desc = "Telescope spell suggest" },
            { "<leader>fm", mode = { "n" }, builtin.man_pages, desc = "Telescope find manuals" },
